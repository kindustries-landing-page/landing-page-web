...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "group toast group-[.toaster]:bg-white group-[.toaster]:text-zinc-900 group-[.toaster]:border-zinc-200 group-[.toaster]:shadow-lg rounded-2xl p-4 flex gap-3 border font-sans text-sm",
          ...
          error: "group-[.toaster]:!bg-rose-50 group-[.toaster]:!text-rose-950 group-[.toaster]:!border-rose-200",
          info: "group-[.toaster]:!bg-blue-50 group-[.toaster]:!text-blue-950 group-[.toaster]:!border-blue-200",
          warning: "group-[.toaster]:!bg-amber-50 group-[.toaster]:!text-amber-950 group-[.toaster]:!border-amber-200",
        },
      }}
      {...props}
    />
